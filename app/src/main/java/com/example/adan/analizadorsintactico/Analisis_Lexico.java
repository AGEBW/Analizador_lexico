...
public class Analisis_Lexico {
    ...
    public String Compile(String Exp, int linea){//Creamos el método que nos analizará la expresión
        ...
        for(int AL=0;AL<TV.length;AL++){
            if(!TV[AL].equals("")){
                if(TV[AL].substring(0,1).equals("N")){
                    TN(TV[AL], linea);
                    ban=true;
                }
                if(TV[AL].substring(0,1).equals("M")){
                    TM(TV[AL], linea);
                    ban=true;
                }
                if(TV[AL].substring(0,1).equals("D")){
                    TD(TV[AL], linea);
                    ban=true;
                }//fin si  el primer caracter de la palabra es 'D'
                if(TV[AL].substring(0,1).equals("A")){
                    TA(TV[AL], linea);
                    ban=true;
                }//fin si  el primer caracter de la palabra es 'D'
                if(TV[AL].substring(0,1).equals("E")){
                    TE(TV[AL], linea);
                    ban=true;
                }
                if(TV[AL].substring(0,1).equals("B")){
                    TB(TV[AL], linea);
                    ban=true;
                }
                if(TV[AL].substring(0,1).equals("S")){
                    TS(TV[AL], linea);
                    ban=true;
                }
                if(TV[AL].substring(0,1).equals("o")){
                    TO(TV[AL], linea);
                    ban=true;
                }
                if(TV[AL].substring(0,1).equals("C")){
                    TC(TV[AL], linea);
                    ban=true;
                }
                if(TV[AL].substring(0,1).equals("I")){
                    TI(TV[AL], linea);
                    ban=true;
                }
                if(TV[AL].substring(0,1).equals("P")){
                    TP(TV[AL], linea);
                    ban=true;
                }
            }
            ...
            if(Q!=null && ban==false){
                switch( Q ){
                    ...
                    default:
                        //nombre de variable
                        int b=0;
                        for(int k=0;k<TV[AL].length();k++){
                            if( !esLetraMin(TV[AL].charAt(k)) ){
                                Simbolos = Simbolos + "Elemento desconocido,"+TV[AL]+",No,?,"+linea+"#";
                                b=1;
                            }
                        }
    ...
    public void TP(String TokD, int linea){
        ...
        switch( State ){
            case "q5"://Cerrar
                Simbolos=Simbolos+TokD+","+TokD+",Reservada,'P' seguida de 'i' seguida de 'n' seguida de 'z' seguida de 'a'"+"#";
                break;
            default://si State no esta entre los estados validos
    ...
    public void TI(String TokD,int linea){
        ...
        switch( State ){
            case "q3"://Cerrar
                Simbolos=Simbolos+TokD+","+TokD+",Reservada,'I' seguida de 'z' seguida de 'q'"+"#";
                break;
            default://si State no esta entre los estados validos
                Simbolos=Simbolos+"Desconocido"+","+TokD+""+"#";
                break;
